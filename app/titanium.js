...
var require = {
	app: {
		analytics: false,
		copyright: "2011 by dawson",
		deployType: "development",
		description: "not specified",
		guid: "caec7753-c202-40b0-be61-ff51c63054f9",
		id: "com.dawson.play2012",
		name: "play",
		names: {},
		publisher: "dawson",
...
p.setString("acs-oauth-key","dSKlrQkgT3XRDHpq2T4YT9o9FveCWCOa");
p.setString("ti.map.apikey","");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-api-key","hFjCgmhtAz8YL2diXS4grbALEhHP9uUw");
p.setString("acs-oauth-secret","wxWj672uxlzv8Fm3Z32tAXV3UEgS1w88");
});
